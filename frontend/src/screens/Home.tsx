...
const Home = () => {
  ...
  return (
    <>
      <Head title="Homepage" />
      <header className="flex min-h-[calc(100vh-7rem)] max-w-[1150px] flex-col py-8 md:flex-row">
        ...
        <div className="mt-10 flex-1 md:mt-0">
          <section className="flex h-full justify-center md:justify-end">
            <img src="https://static-exp1.licdn.com/sc/h/dxf91zhqd2z6b0bwg85ktm5s4" alt="" className="w-full" />
          </section>
        </div>
      </header>
    </>
