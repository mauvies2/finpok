      ...
      <div className='flex-1'>
       ...
       {extraFields.notes && <FormInput
        ...
        <div className='flex mb-4'>
          ...
          {!extraFields.fee && <Button className='btn btn-light ml-2' onClick={()=>addField('fee')}>
            Fee
          </Button>}
          {!extraFields.notes && <Button className='btn btn-light ml-2' onClick={()=>addField('notes')}>
            Notes
          </Button>}
        </div>
